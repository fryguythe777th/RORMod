...
namespace RiskOfTerrain.Projectiles.Misc
{
    public class MeatHookProjVanity : ModProjectile
    {
        ...
        {
            chainTexture = ModContent.Request<Texture2D>("RiskOfTerrain/Projectiles/Misc/MeatHookProjChain");
            hookTexture = ModContent.Request<Texture2D>("RiskOfTerrain/Projectiles/Misc/MeatHookProjVanity");
        }
